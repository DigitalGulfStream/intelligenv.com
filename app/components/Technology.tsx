...
const Technology = () => {
    ...
    return (
        <section>
            <div className='columns-1 flex-col lg:flex-row flex  lg:columns-2 gap-10 mb-20 pb-20 px-5 sm:px-0'>
                ...
                <div className=' lg:ms-0 lg:ps-0 flex w-full flex-col ps-0  sm:ps-5 lg:w-1/2'>
                    ...
                    <div className='flex sm:flex-row flex-col mt-10 w-full'>
                        <div className='flex  flex-col w-full sm:w-3/5 text-slate-500 '>
                            ...
                            <div className='my-10'>
                                <span className='min-w-40	 py-3 buttonCustomize transition duration-300 hover:-translate-y-4 text-white hover:text-black font-medium text-l border border-cyan-400 block sm:float-start rounded-full hover:bg-cyan-400 mt-10'>Learn More</span>
                            </div>
                        </div>
