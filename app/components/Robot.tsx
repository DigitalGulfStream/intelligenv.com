        ...
        <section className='mt-36 flex relative'>
            ...
            <div className='flex w-full items-center  mx-5 sm:mx-0'>
                ...
                <div className='lg:w-1/2 w-full flex flex-col justify-center'>
                    ...
                    <div className='lg:text-start text-center text-slate-500 font-sans mt-5 text-lg'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do 
                    <br/> 
                    eiusmod tempor incididunt ut labore et dolore magna aliqua
                    </div>
                    <div className='flex justify-center mb-5 mt-5 sm:mt-0'>
                    <span className="px-10 py-4 buttonCustomize transition duration-300 hover:-translate-y-4 text-white hover:text-black font-medium text-l border border-cyan-400 block float-start mt-10 rounded-full hover:bg-cyan-400 ">Contact Us</span>
                    </div>
                </div>
